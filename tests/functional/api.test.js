...
describe('API Routes - Tests Fonctionnels', () => {
    ...
    describe('GET /tva', () => {
        ...
        test('devrait retourner une erreur 400 pour des paramètres manquants', async () => {
            ...
            expect(response.body).toHaveProperty('error');
            expect(response.body).toHaveProperty('code', 'TVA_CALCULATION_ERROR');
        });
    ...
    describe('GET /remise', () => {
        ...
        test('devrait retourner une erreur 400 pour des paramètres manquants', async () => {
            ...
            expect(response.body).toHaveProperty('error');
            expect(response.body).toHaveProperty('code', 'DISCOUNT_CALCULATION_ERROR');
        });
    ...
    describe('GET /health', () => {
        test('devrait retourner le statut de santé du service', async () => {
            ...
            expect(response.body).toHaveProperty('service', 'financial-conversion-api');
        });
    });
